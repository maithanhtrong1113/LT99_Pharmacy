  ...
  return (
    <Fragment>
      ...
      <div className="row d-flex justify-content p-2 mb-5">
        <h3 className="fw-bold text-blue-pastel col-xl-12">
          ...
          <div className="container-fluid p-3   ">
            <div className="row text-dark d-flex justify-content-between text-white bg-blue-dark p-3 rounded  shadow">
              ...
              <div className="col-4 d-flex align-items-center">
                ...
                <h5 className="fw-bold mx-2 bg-dark p-3 rounded">{minutes}</h5>
                <h5 className="fw-bold mx-2 bg-dark p-3 rounded">{seconds}</h5>
              </div>
            </div>
